        ...
        <Card className="h-full bg-surface backdrop-blur-xl border border-border shadow-glass">
            ...
            <CardBody>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Transactions Card - Centered and Expanded */}
                    <div className="md:col-start-2 p-5 rounded-xl border border-white/5 bg-black/20 backdrop-blur-sm group hover:border-primary/20 transition-all duration-300">
